...
const Repost = ({postId, userId, isRePosted, rePostCount, replyId}: RepostProps) => {
    ...
    const handleRepost = async() => {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/api/posts/rePosts`, {
            method: "POST",
    ...
    const handleReplyRepost = async() => {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/api/reply/rePosts`, {
            method: "POST",
