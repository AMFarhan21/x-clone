  ...
  return (
    <div className="w-full h-full flex justify-center items-center relative ">
      <div className="max-w-screen-xl w-full h-full flex relative">
        ...
        <LeftSidebar />
        <MainComponent />
        <section className="flex flex-col ml-8 my-1 w-[30%] h-screen space-y-4 sticky top-1 overflow-scroll" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
          {/* SEARCH */}
          ...
          <div className="border border-white/20 rounded-2xl p-4">
            ...
            <div>
              <button className="bg-blue-400 text-white text-sm font-bold px-4 py-2 rounded-full mt-2">Subscribe</button>
            </div>
          </div>


          {/* TRENDING */}
          <div className="border border-white/20 p-4 rounded-2xl space-y-6">
          ...
          <div className="border border-white/20 p-4 rounded-2xl">
            ...
            <div className="mt-6 text-blue-400 text-sm">Show more</div>
          </div>
